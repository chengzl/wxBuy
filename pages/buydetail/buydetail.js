...
Page({
  ...
  saveButton:function(e){
    ...
    let qishu_id = this.data.qishu_id
    wx.navigateTo({
      url: '../ordersubmit/ordersubmit?money='+money+'&goodid=' + goodid + '&qishu_id=' + qishu_id,
        success: function(res){
        },
        fail: function() {
        },
        ...
        wx.request({
          ...
          success: function (detailRes) {
            ...
            if(result){
              ...
              let goods_tags = goods.goods_tags
              let goods_name = goods.goods_name
              let goods_desc = goods.goods_desc
              let market_price = goods.market_price
              that.setData({
                goods:goods,
